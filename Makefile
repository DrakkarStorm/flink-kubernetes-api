...
DOCKER_IMAGE = harbor.knada.rancher.kosmos.fr/public/flink-kubernetes-api
# Tag de l'image Docker
DOCKER_TAG = latest

# Répertoire de l'application Go
APP_DIR = .

# Nom de l'application Go
APP_NAME = flink-kubernetes-api
